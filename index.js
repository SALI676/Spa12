...
app.get('/booking_spa12', async (req, res) => {
    try {
        // Query to select all bookings from 'booking_spa12' table, ordered by datetime for consistency
...
app.post('/booking_spa12', async (req, res) => {
    ...
    try {
        // SQL query to insert a new booking into 'booking_spa12' table.
...
app.delete('/booking_spa12/:id', async (req, res) => {
    ...
    try {
        // SQL query to delete a booking from 'booking_spa12' table by ID
